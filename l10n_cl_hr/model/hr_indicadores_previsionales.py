...
class hr_indicadores_previsionales(models.Model):
    ...
    url_previred = fields.Char("Link Previred", default='<p><a href="https://www.previred.com/web/previred/indicadores-previsionales" class="rounded-circle btn btn-beta rounded-circle btn-sm" target="_blank">Previred</a><br></p>')
