...
class HrEmployee(models.Model):
    ...
    firstname = fields.Char(translate=True, "Firstname")
    last_name = fields.Char(translate=True, "Last Name")
    middle_name = fields.Char(translate=True, "Middle Name", help='Employees middle name')
    mothers_name = fields.Char(translate=True, "Mothers Name", help='Employees mothers name')
