...
class hr_contract(models.Model):
    ...
    bono_vaca = fields.Float('Bono Vacaciones', help="Bono de Vacaciones")
    bono_navidad = fields.Float('Bono Navidad', help="Bono de Navidad")
    aguinaldo_fp = fields.Float('Aguinaldo Fiestas Patrias', help="Aguinaldo Septiembre Fiestas Patrias")	
