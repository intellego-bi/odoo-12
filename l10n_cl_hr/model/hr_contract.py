...
class hr_contract(models.Model):
    ...
    anticipo_sueldo = fields.Monetary('Anticipo de Sueldo', digits=(16, 2), help="Anticipo De Sueldo Realizado Contablemente")
    ...
    #movilizacion = fields.Float('Asig. Movilización', help="Asignación de Movilización Mensual")
    movilizacion = fields.Monetary('Asig. Movilización', digits=(16, 2), help="Asignación de Movilización Mensual")
    ...
    seguro_complementario_id = fields.Many2one('hr.seguro.complementario', 'Nombre SC')
    seguro_complementario = fields.Float('Cotización SC',  help="Seguro Complementario")
    #viatico_santiago = fields.Float('Asig. Viático',  help="Asignación de Viático")
    viatico_santiago = fields.Monetary('Asig. Viático', digits=(16, 2), help="Asignación de Viáticos Mensual")
    ...
    isapre_moneda= fields.Selection((('uf', 'UF'), ('clp', 'Pesos')), 'Tipo de Moneda ISAPRE', default="uf")
    apv_id = fields.Many2one('hr.apv', 'Nombre APV')
    aporte_voluntario = fields.Float('Ahorro Previsional Voluntario (APV)', help="Ahorro Previsional Voluntario (APV)")
    aporte_voluntario_moneda= fields.Selection((('uf', 'UF'), ('clp', 'Pesos')), 'Tipo de Moneda APV', default="uf")
    forma_pago_apv = fields.Selection((('1', 'Directa'), ('2', 'Indirecta')), 'Forma de Pago', default="1")
    seguro_complementario_moneda= fields.Selection((('uf', 'UF'), ('clp', 'Pesos')), 'Tipo de Moneda SC', default="uf")
